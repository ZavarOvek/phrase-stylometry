...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--text-dir", type=Path, default=Path("Samples"),
    ...
    parser.add_argument(
        "--w2v-vector-size", type=int, default=100, help="Word2Vec embedding size (default: 100)",
    )
    parser.add_argument(
        "--w2v-window", type=int, default=3, help="Word2Vec context window (default: 3)",
    )
    parser.add_argument(
        "--w2v-epochs", type=int, default=20, help="Word2Vec training epochs (default: 20)",
    )
    parser.add_argument(
        "--vibe", choices=["clean", "gothic"], default="clean",
